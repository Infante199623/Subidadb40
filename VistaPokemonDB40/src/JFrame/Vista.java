...
import Entrenador1.bdEntrenador;
import EquipoPokemon.EquipoPokemon;
import EquipoPokemon.bd4oEquipo;
import Pokemon.Pokemon;
import Pokemon.bdPokemon;
...
public final class Vista extends javax.swing.JFrame {
    ...
    public void anadirPokemon() throws SQLException{
        
        
      bdPokemon.leerPokemon(arrayPokemon);

    }
    
    public void anadirEntrenador() throws SQLException{
        
        
      bdEntrenador.leerEntrenador(arrayEntrenador);

    }
    
   
    public void anadirRegion() throws SQLException{
        
        
      db4o.leerRegiones(arrayRegion);

    }
     public void anadirEquipo() throws SQLException{
        
        
      bd4oEquipo.leerEquipoPokemon(arrayEquipo);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try{
            ...
            if(existe == false){
                ...
                bd4oEquipo.deleteEquipoPokemon(arrayEquipo.get(i));
        ...
        try{
            ...
            if(valido == false){
             //   RegionControler.NuevoFicheroRegionPokemon(arrayRegion);
                PonerCamposRegionVacios();
                 db4o.deleteRegion(arrayRegion.get(i));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jButton1.isEnabled() == true){
           ...
           db4o.insertarRegion( arrayRegion.get(i));
            ...
            if(existe == false){
                 ...
                 if(textField5.getText().equals("")
                   ...
                   //jComboBox2.addItem(r.getNombre_Equipo());
                    bd4oEquipo.insertarEquipo(r);
                }
            }
        }else{
           
           try{
                bd4oEquipo.deleteEquipoPokemon(arrayEquipo.get(i-1));
            ...
            arrayEquipo.get(i).setId_Equipo(id);
              bd4oEquipo.insertarEquipo(arrayEquipo.get(i));
        ...
        if(jButton11.isEnabled() == true){
            ...
            if(existe == false){
                 ...
                 if(textField9.getText().equals("") 
                   ...
                   bdEntrenador.insertarEntrenador(r);
           ...
           try{
                ...
                arrayEntrenador.get(i).setId_Entrandor(id);
                bdEntrenador.insertarEntrenador(arrayEntrenador.get(i));
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
            ...
            if(existe == true){
                ...
                PonerCamposEntrenadorVacio();
                bdPokemon.deletePokemon(arrayPokemon.get(i));
        ...
        if(jButton16.isEnabled() == true){
           ...
           try{
                ...
                arrayPokemon.get(i).setEntrenador(jComboBox3.getItemAt(j));
                 bdPokemon.insertarPokemon(arrayPokemon.get(i));
           }catch(Exception e){}
        }
         MostrarListaPokemon(arrayPokemon);
         PonerCamposPokemonVacio();
